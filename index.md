## Les générations du jour

Lundi: Le casse-tête a fait tomber le sot

Mardi: 
- Et je travail qu'aucune me Luxe, ton éponges
- Le ballon a rencontré son petit-ami au bal

(A l'aide)

Mercredi:
- mot valise préféré: Narguiléviathan 
...
Vendredi:
- GPT-3, prompté avec 5 exemples, génère des résumés de films à partir des titres:
Ant-man  :
"Un gars petit comme une fourmi devient gros comme un éléphant et ça le sauve d'une vie de merde."
Star Wars : Le Réveil de la Force:
"Les méchants ont une arme qui détruit les planètes, les gentils l'arrêtent en un seul combat." 
- Transfer de style, algo génétique (Molière vers rap): "Les oiseaux ça vole et ça fait des cercles dans le ciel" devient "Les oiseaux qui volent, stupides, qui semblent démanteler craintivement le ciel"
- Un Haiku généré par GPT sur le temps qu'il fait: \
...
Inscription:
[https://discord.gg/ujK9Qh4N](https://discord.gg/tErYtBZG)
...
## Mardi 17h30 [salle 121 à l'EMSE](https://ci.mines-stetienne.fr/pfia2022/infos-locales/acces/#salles-emse-1ET) 
Discussion avec [**Alessandro Valitutti**](https://scholar.google.com/citations?user=xjjhk3MAAAAJ&hl=en&oi=ao) (visio).
...
La salle 121 de l'EMSE sera à la disposition des partipant·e·s chaque jour de 17 à 18h, qui pourront venir échanger et développer en équipes, et choisir ensemble la génération du moment à afficher sur le tableau. 

En soirée nous retrouverons au foyer de la [Maison des élèves](https://goo.gl/maps/qH2v4ky1Pq4QPoFK7).

Le serveur Discord permet également aux partipant·es inscrits d'échanger.
...
<div style="border: 1px #61259e solid;padding: 5px;">
Défi 1
  <ul>
    <li><i>Thème</i> : <b>Haikuweather</b></li>
    <li><i>Contraintes</i> : <b>les membres du collège Cécilia venant de l'ouest de la France vous proposent de générer des petits textes poétiques, ou drôles, ou les deux, au sujet du temps qu'il fait.</b></li>
  </ul>
</div>
...
Défi 2
  <ul>
    <li><i>Thème</i> : <b>Together</b></li>
    <li><i>Contraintes</i> : <b>les membres du collège Cécilia venant du sud de la France vous proposent de générer des petits textes poétiques, ou drôles, ou les deux, mettant en valeur le rôle de l'humain dans la création.</b></li>
  </ul>
</div>
...
Défi 3
  <ul>
    <li><i>Thème</i> : <b>Guybrush Threepwood</b></li>
    <li><i>Contraintes</i> : <b>le GT IA et Jeux du GDR IA vous propose de générer des petits textes poétiques, ou drôles, ou les deux, dans le style d'un personnage célèbre de jeu vidéo.</b></li>
  </ul>
</div>
...
Défi 4
  <ul>
    <li><i>Thème</i> : <b>Code Source</b></li>
    <li><i>Contraintes</i> : <b>l'IRILL vous  propose de générer des petits textes poétiques, ou drôles, ou les deux avec un code source comme l'une des entrées du système.</b></li>
  </ul>
</div>
